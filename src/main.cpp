...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Mon, 09 Jan 2017 05:58:55 +0000";
        CTransaction txNew;
        txNew.nTime = 1483941535;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1483941535;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 6514581;
		if(fTestNet)
        {
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x33a6e42e8e916c587a073295c7f8dca963dfc06173df0f6ffa5a68221479c244"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x42, 0x69, 0x7a, 0x43 };
